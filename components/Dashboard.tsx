    ...
    <FilterProvider costRows={costSaving} utilRows={utilization} allFYs={allFYs}>
      <div className="min-h-screen bg-slate-50">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-blue-200 text-xs">
                  Reliability Lab &mdash; Cost Saving &amp; Machine Utilization
                </p>
              </div>
            </div>
            <div className="text-xs text-blue-200">
              {loading ? (
                ...
                <span className="flex items-center gap-1.5">
                  ...
                  {costSaving.length.toLocaleString()} cost records &bull;{' '}
                  {utilization.length.toLocaleString()} utilization records
                </span>
              )}
            </div>
          </div>
        ...
        <main className="max-w-screen-2xl mx-auto px-6 py-6 flex flex-col gap-6">
          ...
          {/* Heatmap — full width, local machine + local FY filters */}
          <ChartCard className="min-h-[420px]">
